...
describe('ScrollSpiedElementGroup', () => {
  ...
  describe('#onScroll()', () => {
    ...
    beforeEach(() => {
      ...
      spyOn(ScrollSpiedElement.prototype, 'calculateTop')
          .and.callFake(function(this: ScrollSpiedElement) {
...
describe('ScrollSpyService', () => {
  ...
  describe('#onResize()', () => {
    it('should re-calibrate each `ScrollSpiedElementGroup`', () => {
      ...
      const spiedElemGroups: ScrollSpiedElementGroup[] =
          (scrollSpyService as any).spiedElementGroups;
  ...
  describe('#onScroll()', () => {
    ...
    it('should first re-calibrate if the content height has changed', () => {
      ...
      const spiedElemGroups: ScrollSpiedElementGroup[] =
          (scrollSpyService as any).spiedElementGroups;
      const onScrollSpies = spiedElemGroups.map(group => spyOn(group, 'onScroll'));
      const calibrateSpies = spiedElemGroups.map(
          (group, i) => spyOn(group, 'calibrate')
