...
export class TocService {
  ...
  constructor(
      @Inject(DOCUMENT) private document: any, private domSanitizer: DomSanitizer,
...
function querySelectorAll<K extends keyof HTMLElementTagNameMap>(
    parent: Element, selector: K): HTMLElementTagNameMap[K][];
function querySelectorAll<K extends keyof SVGElementTagNameMap>(
    parent: Element, selector: K): SVGElementTagNameMap[K][];
