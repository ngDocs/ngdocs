...
import {CurrentNodes, NavigationNode, navigationPath, NavigationService, NavigationViews, VersionInfo,} from 'app/navigation/navigation.service';
...
describe('NavigationService', () => {
  ...
  describe('node.tooltip', () => {
    ...
    const sideNav: NavigationNode[] =
        [{title: 'a', tooltip: 'a tip'}, {title: 'b'}, {title: 'c!'}, {title: '', url: 'foo'}];
  ...
  describe('currentNode', () => {
        ...
        children: [
          {
            ...
            tooltip: 'tip',
            children:
                [{url: 'c', title: 'c', tooltip: 'tip'}, {url: 'd', title: 'd', tooltip: 'tip'}]
          },
    ...
    const navJson = {TopBar: topBarNodes, SideNav: sideNavNodes, __versionInfo: {}};
       ...
       () => {
         ...
         expect(currentNodes).toEqual({
           SideNav: {
             url: 'b',
             view: 'SideNav',
             nodes: [sideNavNodes[0].children?.[0] as NavigationNode, sideNavNodes[0]]
           }
         });
         ...
         expect(currentNodes).toEqual({
           SideNav: {
             ...
             nodes: [
               ...
               sideNavNodes[0].children?.[0] as NavigationNode, sideNavNodes[0]
             ]
           }
         });
         ...
         expect(currentNodes).toEqual({
           SideNav: {url: 'f', view: 'SideNav', nodes: [sideNavNodes[1]]}
         });
       });
  ...
  describe('versionInfo', () => {
    ...
    beforeEach(() => {
      ...
      httpMock.expectOne({}).flush({__versionInfo: expectedVersionInfo});
    });
