 ...
 *      [embedded]          // embed the stackblitz in the doc page, else display in new browser tab
 * (default) [noDownload]        // no downloadable zip option [downloadOnly]      // just the zip
 *      [title="..."]>      // text for live example link and tooltip
 *        text              // higher precedence way to specify text for live example link and
 * tooltip
 *  </live-example>
 * Example:
 ...
 *   <live-example name="toh-pt1" embedded stackblitz="minimal">Tour of Heroes - Part
 * 1</live-example>
 *   // ~/resources/live-examples/toh-pt1/minimal.stackblitz.json
 */
@Component({selector: 'live-example', templateUrl: 'live-example.component.html'})
