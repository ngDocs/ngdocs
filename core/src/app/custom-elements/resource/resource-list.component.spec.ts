...
describe('ResourceListComponent', () => {
  ...
  class TestLocationService {
    ...
    setSearch =
        jasmine.createSpy('setSearch').and.callFake((_label: string, result: SearchResult) => {
  ...
  function getTestData(): Category[] {
    return [
      ...
      {id: 'development', title: 'Development', order: 0, subCategories: []},
      {id: 'education', title: 'Education', order: 1, subCategories: []},
    ];
  }
});
