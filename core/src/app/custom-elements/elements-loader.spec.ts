import {Compiler, ComponentFactory, ComponentFactoryResolver, ComponentRef, Injector, NgModuleFactory, NgModuleRef, Type,} from '@angular/core';
...
describe('ElementsLoader', () => {
    ...
    const injector = TestBed.configureTestingModule({
      providers: [
        ElementsLoader,
        {
          ...
          useValue: new Map<
              string,
              () => Promise<NgModuleFactory<WithCustomElementComponent>|
  ...
  describe('loadCustomElement()', () => {
    ...
    it('should fail if defining the custom element fails', fakeAsync(() => {
         let state = 'pending';
         elementsLoader.loadCustomElement('element-b-selector')
    ...
    it('should be able to load and register an element after compiling its NgModule',
       fakeAsync(() => {
         const compilerSpy =
...
class FakeComponentFactory extends ComponentFactory<any> {
  ...
  create(
      _injector: Injector, _projectableNodes?: any[][], _rootSelectorOrNode?: string|any,
