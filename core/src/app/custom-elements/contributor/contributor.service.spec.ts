...
describe('ContributorService', () => {
  ...
  beforeEach(() => {
    injector = TestBed.configureTestingModule(
        {imports: [HttpClientTestingModule], providers: [ContributorService]});
  ...
  describe('#contributors', () => {
    ...
    it('should have expected "GDE" contribs in order', () => {
      ...
      const expectedAngularNames =
          [testData.gkalpak, testData.kapunahelewong].map(l => l.name).join(',');
    ...
    it('should support including a contributor in multiple groups', () => {
      ...
      const matchedGroups = contribs.filter(group => group.contributors.includes(contributor))
