...
export class CodeComponent implements OnChanges {
  ...
  constructor(
      private snackbar: MatSnackBar, private pretty: PrettyPrinter, private clipboard: Clipboard,
  ...
  private formatDisplayedCode() {
    ...
    const prettifyCode = this.pretty.formatCode(leftAlignedCode, this.language, linenums)
  ...
  getLinenums() {
    const linenums = typeof this.linenums === 'boolean' ?
        ...
        this.linenums === 'false' ?
        false :
        typeof this.linenums === 'string' ? parseInt(this.linenums, 10) : this.linenums;
