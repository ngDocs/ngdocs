...
describe('CodeExampleComponent', () => {
  ...
  it('should change aio-code classes based on header presence', () => {
    ...
    expect(codeExampleComponent.classes).toEqual({'headed-code': true, 'simple-code': false});
    ...
    expect(codeExampleComponent.classes).toEqual({'headed-code': false, 'simple-code': true});
  });
