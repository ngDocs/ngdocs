...
export class PrettyPrinter {
  ...
  private getPrettyPrintOne(): Promise<PrettyPrintOne> {
    ...
    return ppo ?
        ...
        import('assets/js/prettify.js' as any).then(() => (window as any).prettyPrintOne, err => {
   ...
   * @param [language] - The language of the code to render (could be javascript, html, typescript,
   *     etc)
