...
*/
  ...
  (function() {
    function T(a) {
      function d(e) {
        ...
        return (b = w[a]) ? b :
                            ...
                            'u' === a || 'x' === a ? parseInt(e.substring(2), 16) : e.charCodeAt(1)
      }
      function f(e) {
      ...
      for (var w = {b: 8, t: 9, n: 10, v: 11, f: 12, r: 13}, r = [], m = 0, c = a.length; m < c;
           ++m) {
        p = a[m];
    ...
    function J(a, d, f, b, v) {
      f &&
          (a = {h: a, l: 1, j: null, m: null, a: f, c: null, i: d, g: null}, b(a),
           v.push.apply(v, a.g))
    }
    function V(a) {
    ...
    function G(a, d) {
      function f(a) {
        for (var l = a.i, m = a.h, c = [l, 'pln'], p = 0, w = a.a.match(v) || [], r = {}, e = 0,
                 t = w.length;
             e < t; ++e) {
    ...
    function L(a, d, f) {
      function b(a) {
        ...
        if (1 == c && !A.test(a.className))
          ...
          q &&
              (c = d.substring(0, q.index), a.nodeValue = c,
      ...
      for (var p = 0, r = c.length; p < r; ++p)
        ...
        m.firstChild || m.appendChild(l.createTextNode('\u00a0')), w.appendChild(m);
      a.appendChild(w)
    }
    function t(a, d) {
      for (var f = d.length; 0 <= --f;) {
        var b = d[f];
        I.hasOwnProperty(b) ? E.console && console.warn('cannot override language handler %s', b) :
                              I[b] = a
      }
    }
    function K(a, d) {
    ...
    function M(a) {
      ...
      try {
        ...
        var v = /\bMSIE\s(\d+)/.exec(navigator.userAgent), v = v && 8 >= +v[1], d = /\n/g, A = a.a,
            n = A.length, f = 0, l = a.c, m = l.length, b = 0, c = a.g, p = c.length, w = 0;
        c[p] = n;
        var r, e;
    ...
    var Y = E.PR = {
      ...
      prettyPrint: E.prettyPrint =
          function(a, d) {
            function f() {
              for (var b = E.PR_SHOULD_USE_CONTINUATION ? c.now() + 250 : Infinity;
            ...
            var p = 0, w = /\blang(?:uage)?-([\w.]+)(?!\S)/, r = /\bprettyprint\b/,
                e = /\bprettyprinted\b/, y = /pre|xmp/i, z = /^code$/i, q = /^(?:pre|code|xmp)$/i,
                g = {};
            f()
          }
    },
