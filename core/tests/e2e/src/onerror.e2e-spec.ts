...
describe('onerror handler', () => {
  ...
  it('(called without an error object) should call ga with a payload based on the message, url, row and column arguments',
     async () => {
       const message1 =
           await callOnError('Error: some error message', 'some-file.js', 12, 3, undefined);
       expect(message1).toEqual('some error message\nsome-file.js:12:3');
       const message2 = await callOnError(
           'Error: some error message', undefined, undefined, undefined, undefined);
       expect(message2).toEqual('some error message\nnull:?:?');
     });

  it('(called without an error object) should call ga with a payload that is no longer that 150 characters',
     async () => {
  ...
  it('(called with a Firefox on android style error) should call ga with a payload based on the error object',
     async () => {
       const message = await callOnError(
           'Error: something terrible has happened. oh no. oh no.', undefined, undefined, undefined,
           {
...
createDirectiveInstance@core.umd.j`);
  ...
  it('(called with a Safari 11 style error) should call ga with a payload based on the error object',
     async () => {
       const message = await callOnError(
           'Error: something terrible has happened. oh no. oh no.', undefined, undefined, undefined,
           {
...
cr`);
  ...
  it('(called with a Opera 50 style error) should call ga with a payload based on the error object',
     async () => {
       const message = await callOnError(
           'Error: something terrible has happened. oh no. oh no.', undefined, undefined, undefined,
           {
...
createDirectiveInstance@core.u`);
  ...
  it('(called with a Chrome 64 style error) should call ga with a payload based on the error object',
     async () => {
       const message = await callOnError(
           'Error: something terrible has happened. oh no. oh no.', undefined, undefined, undefined,
           {
...
createDirectiveInstance@core.u`);
  ...
  it('(called with a Firefox 58 style error) should call ga with a payload based on the error object',
     async () => {
       const message = await callOnError(
           'Error: something terrible has happened. oh no. oh no.', undefined, undefined, undefined,
           {
...
createDirectiveInstance@core.umd.j`);
  ...
  it('(called with a Edge 16 style error) should call ga with a payload based on the error object',
     async () => {
       const message = await callOnError(
           'Error: something terrible has happened. oh no. oh no.', undefined, undefined, undefined,
           {
...
createViewNodes@???`);
  ...
  async function callOnError(
      message: string, url?: string, line?: number, column?: number, error?: Error) {
