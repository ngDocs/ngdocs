...
/**
 * The shape of an item in a PWA manifest's icons list (such as the value of the top-level `icons`
 * property or that of the `icons` property of a shortcut item). See
 * https://w3c.github.io/manifest/#manifestimageresource-and-its-members.
 */
