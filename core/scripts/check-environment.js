 ...
 * We use a different file, because some of the tests and error messages are not relevant for
 * `aio/`.
 */
...
checkEnvironment({nodeVersion: engines.node, yarnVersion: engines.yarn});
