    ...
    expect(getDeploymentsInfoFor({
      ...
      CI_COMMIT: 'DUMMY_TEST_COMMIT',
        ...
        .toEqual([
          {
            skipped: true,
            reason: 'Skipping deploy because DUMMY_TEST_COMMIT is not the latest commit ' +
    ...
    expect(getDeploymentsInfoFor({
      ...
      CI_COMMIT: latestCommits['2.1.x'],
        ...
        .toEqual([
          {
            skipped: true,
            reason: 'Skipping deploy of branch "2.1.x" to Firebase.\n' +
    ...
    expect(getDeploymentsInfoFor({
      ...
      CI_COMMIT: latestCommits['4.3.x'],
        ...
        .toEqual([
          {
            skipped: true,
            reason: 'Skipping deploy of branch "4.3.x" to Firebase.\n' +
    ...
    expect(getDeploymentsInfoFor({
      ...
      CI_COMMIT: latestCommits['4.4.x'],
        ...
        .toEqual([
          {
            skipped: true,
            reason: 'Skipping deploy of branch "4.4.x" to Firebase.\n' +
