...
class ExampleBoilerPlate {
  ...
  add() {
    ...
    exampleFolders.forEach(exampleFolder => {
      ...
      // Compute additional boilerplate files that should not be copied over for this specific
      // example This allows the example to override boilerplate files locally, perhaps to include
      // doc-regions specific to the example.
