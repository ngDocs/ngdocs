 ...
 * [rehype-autolink-headings](https://github.com/wooorm/rehype-autolink-headings) that supports
 * ignoring headings with the `no-anchor` class.
 */
...
const link = options => tree => visit(tree, node => {
...
module.exports = [
  ...
  [
    link, {
      properties:
          {title: 'Link to this heading', className: ['header-link'], 'aria-hidden': 'true'},
      content: [{
        type: 'element',
        tagName: 'i',
