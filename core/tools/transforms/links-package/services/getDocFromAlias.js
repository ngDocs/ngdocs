 ...
 *
 * @property {Array<(alias: string, originatingDoc: Doc, ambiguousDocs: Doc[]) => Doc[]>}
 * disambiguators a collection of functions that attempt to resolve ambiguous links. Each
 * disambiguator returns a new collection of docs with unwanted ambiguous docs removed (see
 * links-package/service/disambiguators for examples).
 */
