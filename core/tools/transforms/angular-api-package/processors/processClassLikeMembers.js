...
function computeMemberDescription(member) {
  if (!member.description && member.overloads) {
    ...
    member.description = member.overloads.map(overload => overload.description)
