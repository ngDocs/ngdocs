...
describe('processNgModuleDocs processor', () => {
  ...
  it('should run after the correct processor', () => {
    expect(processor.$runAfter).toEqual([
      'extractDecoratedClassesProcessor', 'computeIdsProcessor'
    ]);
  });

  it('should convert non-array NgModule options to arrays', () => {
    const docs = [{docType: 'ngmodule', ngmoduleOptions: {a: ['AAA'], b: 'BBB', c: 42}}];
  ...
  it('should link directive/pipe docs with their NgModule docs (sorted by id)', () => {
    ...
    const ngModule1 =
        {docType: 'ngmodule', id: 'NgModule1', aliases: ['NgModule1'], ngmoduleOptions: {}};
    const ngModule2 =
        {docType: 'ngmodule', id: 'NgModule2', aliases: ['NgModule2'], ngmoduleOptions: {}};
    const directive1 =
        {docType: 'directive', id: 'Directive1', ngModules: ['NgModule1'], directiveOptions};
    const directive2 =
        {docType: 'directive', id: 'Directive2', ngModules: ['NgModule2'], directiveOptions};
    const directive3 = {
      docType: 'directive',
      id: 'Directive3',
    ...
    processor.$process(
        [ngModule1, pipe2, directive2, directive3, pipe1, ngModule2, directive1, pipe3]);
  ...
  it('should link classes that have a `providedIn` property on an @Injectable decorator that references a known NgModule doc',
     () => {
       ...
       const injectable1 = {
         docType: 'class',
         name: 'Injectable1',
         decorators: [{name: 'Injectable', argumentInfo: [{providedIn: '\'root\''}]}]
       };
       const injectable2 = {
         docType: 'class',
         name: 'Injectable2',
         decorators: [{name: 'Injectable', argumentInfo: [{providedIn: '\'platform\''}]}]
       };
       const injectable3 = {
         docType: 'class',
         name: 'Injectable3',
       ...
       const injectable5 = {
         docType: 'class',
         name: 'Injectable5',
         decorators: [{name: 'Injectable', argumentInfo: [{providedIn: 'NgModule1'}]}]
       };
       const injectable6 = {
         docType: 'class',
         name: 'Injectable6',
         decorators: [{name: 'Injectable', argumentInfo: [{providedIn: 'NgModule2'}]}]
       };
       ...
       aliasMap.addDoc(ngModule2);
       processor.$process([
         ngModule1, ngModule2, injectable1, injectable2, injectable3, injectable4, injectable5,
         injectable6, injectable7, nonInjectable
       ]);
  ...
  it('should link classes that have a `providedIn` property on a ɵprov static that references a known NgModule doc',
     () => {
       ...
       const injectable1 = {
         docType: 'class',
         name: 'Injectable1',
         symbol: createSymbolWithProvider('\'root\'')
       };
       const injectable2 = {
         docType: 'class',
         name: 'Injectable2',
         symbol: createSymbolWithProvider('\'platform\'')
       };
       const injectable3 = {
         docType: 'class',
         name: 'Injectable3',
       ...
       const injectable5 = {
         docType: 'class',
         name: 'Injectable5',
         symbol: createSymbolWithProvider('NgModule1')
       };
       const injectable6 = {
         docType: 'class',
         name: 'Injectable6',
         symbol: createSymbolWithProvider('NgModule2')
       };
       const injectable7 = {docType: 'class', name: 'Injectable7'};
       const nonInjectable = {docType: 'class', name: 'nonInjectable'};
  ...
  it('should link injectables that are marked with `@ngModule` JSDOC tags', () => {
    ...
    const ngModule2 = {
      ...
      id: 'NgModule2',
      aliases: ['NgModule2'],
      ngmoduleOptions: {providers: ['PROVIDER']}
    };
    ...
    aliasMap.addDoc(ngModule2);
    processor.$process(
        [ngModule1, ngModule2, injectable1, injectable2, injectable3, nonInjectable]);
  ...
  it('should link injectables that are parsed out of `@NgModule` decorators', () => {
    const ngModule1 = {
      ...
      id: 'NgModule1',
      ngmoduleOptions:
          {providers: ['Injectable1', '{ provide: Injectable2, useClass: Injectable2 }']}
    };
    const ngModule2 = {
      docType: 'ngmodule',
      id: 'NgModule2',
      ngmoduleOptions: {providers: ['{ provide: Injectable3, useValue: {} }']}
    };
  ...
  it('should error if an injectable that has a `providedIn` property that references an unknown NgModule doc',
     () => {
       ...
       const injectable = {
         docType: 'class',
         name: 'Injectable1',
         decorators: [{name: 'Injectable', argumentInfo: [{providedIn: 'NgModuleRef'}]}]
       };
  ...
  it('should error if an injectable that has a `providedIn` property that references an ambiguous NgModule doc',
     () => {
       ...
       const ngModule1 =
           {docType: 'ngmodule', id: 'NgModule1', aliases: ['NgModuleRef'], ngmoduleOptions: {}};
       const ngModule2 =
           {docType: 'ngmodule', id: 'NgModule2', aliases: ['NgModuleRef'], ngmoduleOptions: {}};
       const injectable = {
         docType: 'class',
         name: 'Injectable1',
         decorators: [{name: 'Injectable', argumentInfo: [{providedIn: 'NgModuleRef'}]}]
  ...
  it('should not error if an abstract directive does not have a `@ngModule` tag', () => {
    ...
    expect(() => {
      processor.$process(
          [{docType: 'directive', id: 'AbstractDir', directiveOptions: {selector: undefined}}]);
    }).not.toThrow();
  });
  ...
  it('should error if a pipe/directive does not have a `@ngModule` tag', () => {
    ...
    expect(() => {
      processor.$process(
          [{docType: 'directive', id: 'Directive1', directiveOptions: {selector: 'dir1'}}]);
    }).toThrowError('Failed to process NgModule relationships.');
    expect(log.error).toHaveBeenCalledWith(
  ...
  it('should error if a pipe/directive has an @ngModule tag that matches more than one NgModule doc',
     () => {
       ...
       const log = injector.get('log');
       const ngModule1 =
           {docType: 'ngmodule', id: 'NgModule1', aliases: ['NgModuleAlias'], ngmoduleOptions: {}};
       const ngModule2 =
           {docType: 'ngmodule', id: 'NgModule2', aliases: ['NgModuleAlias'], ngmoduleOptions: {}};
       aliasMap.addDoc(ngModule1);
       aliasMap.addDoc(ngModule2);
...
function createSymbolWithProvider(providedIn) {
  ...
  const valueDeclaration = {
    initializer: {arguments: [{properties: [{name: {text: 'providedIn'}, initializer}]}]}
  };
