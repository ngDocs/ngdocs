...
describe('createNoMarkdownHeadings rule', () => {
  ...
  it('should return `undefined` if there is no heading in a value', () => {
    expect(noMarkdownHeadings({}, 'description', 'some ## text')).toBeUndefined();
  });
  ...
  describe('(specified heading levels)', () => {
    it('should take heading levels into account', () => {
      ...
      expect(noTopLevelHeadings({}, 'description', '## second level')).toBeUndefined();
      expect(noTopLevelHeadings({}, 'description', '### third level')).toBeUndefined();
      expect(noTopLevelHeadings({}, 'description', '#### fourth level')).toBeUndefined();
      ...
      expect(allowLevel3Headings({}, 'description', '### third level')).toBeUndefined();
